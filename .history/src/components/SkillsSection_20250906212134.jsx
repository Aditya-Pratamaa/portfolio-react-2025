    ...
    <div className="bg-white py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        ...
        {skillsData.map((category, catIndex) => (
          <div key={catIndex} className="mb-12">
            <motion.div
              ...
              className="inline-block px-6 py-2 rounded-full bg-red-100 text-red-700 text-sm font-semibold mb-8"
            >
              {category.category}
            </motion.div>
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-x-4 gap-y-8 justify-items-center">
              {category.items.map((skill, skillIndex) => (
                <motion.div
                  ...
                  className="flex flex-col items-center p-4 bg-gray-50 rounded-lg shadow-md w-24 h-24 justify-center cursor-pointer"
                >
                  <div className="w-12 h-12 mb-2" dangerouslySetInnerHTML={{ __html: skill.icon }}></div>
        ...
        <motion.p
          ...
          className="text-gray-600 text-lg mt-12 tracking-wide"
        >
