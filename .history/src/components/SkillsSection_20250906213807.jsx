...
const skillsData = [
  {
    ...
    items: [
      ...
      { name: "MySQL", icon: "<img src=\"https://img.icons8.com/color/48/000000/mysql.png\" alt=\"MySQL\" />" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Notion", icon: "<img src=\"https://upload.wikimedia.org/wikipedia/commons/e/e9/Notion-logo.svg\" alt=\"Git\" />" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {skillsData.map((category, catIndex) => (
            <div key={catIndex} className="flex flex-col items-center">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-3 lg:grid-cols-4 gap-6 justify-items-center mb-8">
                {category.items.map((skill, skillIndex) => (
                  ...
                  >
                    <div className="w-10 h-10 mb-2" dangerouslySetInnerHTML={{ __html: skill.icon }}></div>
