...
const skillsData = [
  {
    ...
    items: [
      ...
      {
        name: "React",
        icon: '<img src="https://img.icons8.com/color/48/000000/react-native.png" alt="React" />',
      },
      {
        name: "Tailwind",
        icon: '<img src="https://img.icons8.com/color/48/000000/tailwindcss.png" alt="Tailwind" />',
      },
      {
        name: "Laravel",
        icon: '<img src="https://img.icons8.com/color/48/000000/laravel.png" alt="Laravel" />',
      },
      {
        name: "Bootstrap",
