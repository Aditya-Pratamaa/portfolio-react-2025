    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-rose-50 via-pink-50 to-red-50">
      ...
      <nav className="relative z-10 flex items-center justify-between p-6">
        ...
        <div className="flex items-center gap-6">
          <a href="#" className="text-gray-600 hover:text-rose-600 transition-colors duration-300">About</a>
          <a href="#" className="text-gray-600 hover:text-rose-600 transition-colors duration-300">Projects</a>
          <a href="#" className="text-rose-600 font-semibold">Contact</a>
          <button className="p-2 rounded-full bg-white/60 backdrop-blur-sm border border-rose-200 hover:bg-white/80 transition-all duration-300">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mt-20 p-8 bg-gradient-to-r from-rose-500 to-pink-500 rounded-3xl text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-rose-600 px-8 py-3 rounded-full font-semibold hover:bg-rose-50 transition-all duration-300 transform hover:scale-105">
              View My Work
            </button>
