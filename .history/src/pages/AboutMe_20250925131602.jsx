          ...
          {tabs.map(tab => (
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 ${ 
                activeTab === tab.id 
                  ? 'bg-gradient-to-r from-rose-500 to-pink-500 text-white shadow-lg dark:from-rose-600 dark:to-pink-600' 
                  : 'bg-white/60 text-gray-700 border border-rose-200 hover:bg-white/80 dark:bg-gray-800/60 dark:text-gray-300 dark:border-gray-700 dark:hover:bg-gray-800/80'
              }`}
            >
