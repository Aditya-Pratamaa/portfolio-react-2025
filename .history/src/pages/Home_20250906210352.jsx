...
function Home() {
  return (
    <motion.div 
      ...
      className="bg-red-50 relative overflow-hidden font-serif"
    >
      <Navbar />
      <div className="min-h-screen flex items-center justify-center">
        ...
        <motion.span
          ...
          className="fixed text-[15rem] font-bold text-red-100 opacity-60 pointer-events-none top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 select-none z-0 tracking-widest leading-none"
        >
          SOFTWARE
        </motion.span>
        <motion.span
